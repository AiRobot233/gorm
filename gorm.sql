...
INSERT INTO `role` VALUES (2, 1, '系统管理员1', '1,2,3,5,6,7,14,18', '2022-07-19 14:17:49', '2022-09-16 15:34:01', NULL, 1);
...
-- Records of rule
-- ----------------------------
INSERT INTO `rule` VALUES (1, 0, 'Root', 'page', 'root', 255, NULL);
INSERT INTO `rule` VALUES (2, 1, '首页', 'page', 'home', 254, NULL);
INSERT INTO `rule` VALUES (3, 18, '规则配置', 'page', 'rule', 0, NULL);
INSERT INTO `rule` VALUES (4, 18, '角色配置', 'page', 'role', 0, NULL);
INSERT INTO `rule` VALUES (5, 18, '用户管理', 'page', 'user', 0, NULL);
INSERT INTO `rule` VALUES (6, 3, '列表', 'api', '/admin/rule', 0, 'GET');
INSERT INTO `rule` VALUES (7, 3, '添加', 'api', '/admin/rule', 0, 'POST');
INSERT INTO `rule` VALUES (8, 3, '修改', 'api', '/admin/rule', 0, 'PUT');
INSERT INTO `rule` VALUES (9, 3, '删除', 'api', '/admin/rule', 0, 'DELETE');
INSERT INTO `rule` VALUES (10, 4, '列表', 'api', '/admin/role', 0, 'GET');
INSERT INTO `rule` VALUES (11, 4, '添加', 'api', '/admin/role', 0, 'POST');
INSERT INTO `rule` VALUES (12, 4, '修改', 'api', '/admin/role', 0, 'PUT');
INSERT INTO `rule` VALUES (13, 4, '删除', 'api', '/admin/role', 0, 'DELETE');
INSERT INTO `rule` VALUES (14, 5, '列表', 'api', '/admin/user', 0, 'GET');
INSERT INTO `rule` VALUES (15, 5, '新增', 'api', '/admin/user', 0, 'POST');
INSERT INTO `rule` VALUES (16, 5, '修改', 'api', '/admin/user', 0, 'PUT');
INSERT INTO `rule` VALUES (17, 5, '删除', 'api', '/admin/user', 0, 'DELETE');
INSERT INTO `rule` VALUES (18, 1, '系统设置', 'page', 'system', 0, NULL);
